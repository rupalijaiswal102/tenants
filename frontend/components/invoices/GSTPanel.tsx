...
interface Props {
  ...
  watchApplyGst: boolean;
  watchedItems:  any[];
}

export function GSTPanel({ register, setValue, watchApplyGst, watchedItems }: Props) {
  const calcSubTotal = () =>
    watchedItems.reduce((a: number, i: any) => a + (Number(i.amount) || 0), 0);
